...
public class Tentang_damkar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tentang_damkar);
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toolbar1 = new Intent(Tentang_damkar.this, MainActivity.class);
    ...
    public void getData(){
        initializeArray();
        //URL
        AndroidNetworking.get("https://tekajeapunya.com/kelompok_9/laporpak/getData_damkar.php")
                .setTag("Get Data")
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                final CLV_DataDamkar adapter = new CLV_DataDamkar(Tentang_damkar.this,array_fungsi,array_tugas,array_kewenangan);

                                //Set adapter to list
                                listProses.setAdapter(adapter);

                            }else{
                                Toast.makeText(Tentang_damkar.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
