...
public class CLV_DataDamkar extends ArrayAdapter<String> {
    private final Activity context;
    private ArrayList<String> vFungsi;
    private ArrayList<String> vTugas;
    private ArrayList<String> vKewenangan;

    public CLV_DataDamkar(Activity context, ArrayList<String> Fungsi, ArrayList<String> Tugas, ArrayList<String> Kewenangan)
    {
        super(context, R.layout.list_item_damkar,Fungsi);
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        View rowView = inflater.inflate(R.layout.list_item_damkar, null, true);
