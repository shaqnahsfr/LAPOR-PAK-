...
public class Tentang_medis extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                toolbar1 = new Intent(Tentang_medis.this, MainActivity.class);
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if(status){
                                ...
                                final CLV_DataMedis adapter = new CLV_DataMedis(Tentang_medis.this,array_hak,array_kewajiban,array_kewenangan);

                                //Set adapter to list
                                listProses.setAdapter(adapter);

                            }else{
                                Toast.makeText(Tentang_medis.this, "Gagal Mengambil Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                        catch (Exception e){
                            e.printStackTrace();
